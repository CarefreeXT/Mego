...
FROM    ( SELECT    c.""Id"" ,
        ...
        INNER JOIN ""public"".""Customers"" AS b ON a.""CustomerId"" = b.""Id"";";
...
FROM    ( SELECT    c.""Id"" ,
        ...
        LEFT JOIN ( SELECT  d.""OrderId"" ,
                    ...
                    FROM    ""public"".""OrderDetails"" AS d
                            LEFT JOIN ""public"".""Products"" AS e ON d.""ProductId"" = e.""Id""
...
FROM    ""public"".""Orders"" AS a
        LEFT JOIN ( SELECT  c.""OrderId"" ,
                            ...
                            d.""UpdateDate""
                    FROM    ""public"".""OrderDetails"" AS c
                            LEFT JOIN ""public"".""Products"" AS d ON c.""ProductId"" = d.""Id""
                  ) AS b ON b.""OrderId"" = a.""Id"";";
