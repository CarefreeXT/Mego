...
(""Id"",""Address1"",""Name"")
VALUES(:p0,:p1 || :p2,:p3 || :p6) 
RETURNING ""Address1"",""Name"" INTO :p4,:p5";
...
VALUES(""SIMPLE"".""ProductSequence"".NEXTVAL,:p0,:p1,:p2,:p3 || :p7,SYSDATE) 
RETURNING ""Id"",""Name"",""UpdateDate"" INTO :p4,:p5,:p6";
...
VALUES(:p0,SYSDATE,:p5,SYSDATE,:p1) 
RETURNING ""CreateDate"",""CustomerId"",""ModifyDate"" INTO :p2,:p3,:p4";
