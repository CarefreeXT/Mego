namespace Caredev.Mego.Tests.Core.Commit.Simple
{
    ...
    [TestClass, TestCategory(Constants.TestCategoryRootName + ".Commit.Update")]
    public partial class UpdateTest : ISimpleTest
    {
        [TestMethod]
        ...
        public void UpdateGenerateSingleObjectTest()
        {
            Utility.CommitTest(CreateContext(), db =>
            {
                ...
                db.Executor.Execute(operate);
                var value = db.Products.FirstOrDefault(a => a.Id == 11);
                Assert.IsNotNull(value);
                Assert.AreEqual(value.Name, "Customer 100");
            });
        }
